...
- **Add Cheat dialog improved for Nintendo 64** — the dialog now shows the correct code format per system, and N64 codes in unsupported formats are flagged with guidance instead of being silently dropped (thanks @Ekamekia for the repro video and tracking down the code-format source, #293).
...
Huge thanks to everyone who reported bugs, shared logs and reproduction steps, tested fixes, and suggested improvements this release: @cwscws, @CamberwelK, @alfonsico, @gingerbeardman, and @Ekamekia.
